...
public class WashIronActivity extends AppCompatActivity { // Defines the WashIronActivity class, which extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) { // Called when the activity is created
        ...
        setContentView(R.layout.activity_wash_iron); // Sets the layout file for this activity
    }
}
