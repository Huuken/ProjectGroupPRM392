 ...
 */
public class HelpFragment extends Fragment { // Declares the HelpFragment class, extending Fragment for fragment functionality.
    ...
    public HelpFragment() { // Defines the public constructor for the fragment.
    ...
    public static HelpFragment newInstance(String param1, String param2) { // Defines a static factory method to create a new instance of HelpFragment.
        HelpFragment fragment = new HelpFragment(); // Creates a new instance of HelpFragment.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) { // Defines the onCreateView method, called to create the fragment's view.
        ...
        return inflater.inflate(R.layout.fragment_help, container, false); // Inflates the fragment_help layout and returns it as the fragment's view.
